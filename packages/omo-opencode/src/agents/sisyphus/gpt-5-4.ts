...
export function buildGpt54SisyphusPrompt(
  ...
  return t("agents.sisyphus.prompt.gpt-5-4", { agentIdentity: agentIdentity, constraintsBlock: constraintsBlock, delegationBlock: delegationBlock, executionLoopBlock: executionLoopBlock, exploreBlock: exploreBlock, identityBlock: identityBlock, intentBlock: intentBlock, styleBlock: styleBlock, tasksSection: tasksSection });
